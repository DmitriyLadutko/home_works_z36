...
class Square(Figure):
    ...
    def square_length(self):
        dist = self.calc_distance(point_1=self.a, point_2=self.b)
        perimeter = (dist / 2 ** 0.5) * 4
        return round(perimeter)

    def square_area(self):
        dist_1 = self.calc_distance(point_1=self.a, point_2=self.b)
        dist_2 = self.calc_distance(point_1=self.a, point_2=self.b)
        return round(dist_1 * dist_2)
...
class Circle(Figure):
    ...
    def circle_length(self):
        dist = self.calc_distance(point_1=self.a, point_2=self.b)
        return round(2 * (pi * dist * dist))

    def circle_area(self):
        dist = self.calc_distance(point_1=self.a, point_2=self.b)
        return round((pi * dist * dist))
